...
(function (window) {
  ...
  var RoutingClass = function (u, f, t) {
    this.Params = u.split("/").filter(function (h) {
      return h.length > 0;
    });
    this.Url = u;
    this.Fn = f;
  ...
  $M.navigateTo = function (navigateTo) {
    ...
    // console.log(76, PATH_NAME);
    // const FILE_NAME = PATH_NAME.split("/").pop();
    // console.log(76, FILE_NAME);
    // let newPathName = PATH_NAME.replace(`/${FILE_NAME}`, navigateTo + ".html");
